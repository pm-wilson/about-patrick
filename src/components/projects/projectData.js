export const groupProjectData = [{
  ...
  p1: 'Full stack Node, Python, React app that pulls data from various REST API&apos;s to create a web magazine. I was primarily responsible for the endpoints on the back end, building page layouts with React and styling with CSSFull stack Node, Python, React app that pulls data from various REST API&apos;s to create a web magazine. I was primarily responsible for the endpoints on the back end, building page layouts with React and styling with CSS on the front end. on the front end.',
